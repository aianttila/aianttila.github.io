...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
      ...
      <div class="periodical"><em>{{ link.conference }}</em> {% if link.issue %} {{ link.issue }}{% endif %}{% if link.number %}({{ link.number }}){% endif %}: {% if link.pages %} {{ link.pages }}{% endif %}{% if link.year %} ({{ link.year }}) {% endif %}
      </div>
    <div class="links">
      {% if link.paper %} 
