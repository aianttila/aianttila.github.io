...
<h3 id="forthcoming" style="margin: 2px 0px -15px;">Publications</h3>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
      ...
      <div class="periodical"><em>{{ link.conference }}</em> {% if link.issue %} , {{ link.issue }}({{ link.number }}): {{ link.pages }} ({{ link.year }}) {% endif %}
      </div>
    <div class="links">
      {% if link.paper %} 
